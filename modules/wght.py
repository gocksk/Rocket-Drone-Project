...
def growth_split(history: list, resp_parts_of) -> dict:
    ...
    ⚠ 전체 폭(2×h_split)은 w_fill 계단 간격보다 커야 한다. 계단 간격은 일정하지
      않다 — 설계공간 9 점 실측에서 MTOW 대비 6.5~12.9 % 였고(문서의 '약 0.14 kg'
      은 평균), 최악이 12.92 % 라 h_split > 6.46 % 가 필요하다. 0.10 으로 잡아
      여유 1.55 배를 뒀다. 좁으면 구조 항이 계단에 갇혀 0 에 가깝게 나온다.
