...
h_split = 0.05            # ICD외 growth_split 할선 반폭 (MTOW 상대, 좌우로 적용) [-]
                          #   w_fill 계단 간격이 MTOW 의 약 11 %(0.14/1.29) 라 전체 폭이
                          #   그보다 커야 한다 → ±5 % = 전체 10 %. 11-45 표의 ±5 % 열과 같고,
                          #   ±5 % 와 ±20 % 가 사실상 같으므로(0.006589 / 0.006593) 그 이상은
                          #   불필요하다. 좁히면 구조 항이 계단에 갇혀 13 배 과소평가된다.
